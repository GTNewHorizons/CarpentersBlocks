...
public class BlockCoverable extends BlockContainer {
            ...
            if (PlayerPermissions.hasElevatedPermission(TE, entityPlayer, false)) {
                ...
                if (itemStack != null) {
                    ...
                    if (itemStack.getItem() instanceof ICarpentersHammer
                            && ((ICarpentersHammer) itemStack.getItem()).canUseHammer(world, entityPlayer)) {
    ...
    public float getBlockHardness(World world, int x, int y, int z) {
        ...
        if (BlockProperties.hasAttribute(TE, TE.ATTR_COVER[6])) {
            ...
            return b instanceof IWrappableBlock
                    ? ((IWrappableBlock) b).getHardness(world, x, y, z, b, is.getItemDamage())
                    : b.getBlockHardness(world, x, y, z);
        }
    ...
    public int getFlammability(IBlockAccess blockAccess, int x, int y, int z, ForgeDirection side) {
        ...
        if (TE != null) {
            ...
            Block b = BlockProperties.toBlock(is);
            return b instanceof IWrappableBlock
                    ? ((IWrappableBlock) b).getFlammability(blockAccess, x, y, z, side, b, is.getItemDamage())
                    : Blocks.fire.getFlammability(b);
        }
    ...
    public int getFireSpreadSpeed(IBlockAccess blockAccess, int x, int y, int z, ForgeDirection side) {
        ...
        if (TE != null) {
            ...
            Block b = BlockProperties.toBlock(is);
            return b instanceof IWrappableBlock
                    ? ((IWrappableBlock) b).getFireSpread(blockAccess, x, y, z, side, b, is.getItemDamage())
                    : Blocks.fire.getEncouragement(b);
        }
    ...
    public boolean isFireSource(World world, int x, int y, int z, ForgeDirection side) {
        ...
        if (TE != null) {
            ...
            return b instanceof IWrappableBlock
                    ? ((IWrappableBlock) b).sustainsFire(world, x, y, z, side, b, is.getItemDamage())
                    : b.isFireSource(world, x, y, z, side);
        }
        return false;
    }
    ...
    public boolean isWood(IBlockAccess blockAccess, int x, int y, int z) {
        ...
        if (BlockProperties.hasAttribute(TE, TE.ATTR_COVER[6])) {
            ...
            return b instanceof IWrappableBlock
                    ? ((IWrappableBlock) b).isLog(blockAccess, x, y, z, b, is.getItemDamage())
                    : b.isWood(blockAccess, x, y, z);
        }
    ...
    protected boolean isBlockSolid(IBlockAccess blockAccess, int x, int y, int z) {
        ...
        if (TE != null) {
            return !TE.hasAttribute(TE.ATTR_COVER[6])
                    || BlockProperties.toBlock(BlockProperties.getCover(TE, 6)).isOpaqueCube();
        } else {
            return false;
        }
    }
    ...
    public int colorMultiplier(IBlockAccess blockAccess, int x, int y, int z) {
        ...
        if (TE != null) {
            ...
            Block block = BlockProperties.toBlock(itemStack);
            if (!(block instanceof BlockCoverable)) {
                return block instanceof IWrappableBlock
                        ? ((IWrappableBlock) block)
                                .getColorMultiplier(blockAccess, x, y, z, block, itemStack.getItemDamage())
