...
public class Gate {
    ...
    public static final byte TYPE_VANILLA_X1 = Barrier.TYPE_VANILLA_X1;
    public static final byte TYPE_VANILLA_X2 = Barrier.TYPE_VANILLA_X2;
    public static final byte TYPE_VANILLA_X3 = Barrier.TYPE_VANILLA_X3;
    public static final byte TYPE_PICKET = Barrier.TYPE_PICKET;
    public static final byte TYPE_SHADOWBOX = Barrier.TYPE_SHADOWBOX;
    public static final byte TYPE_WALL = Barrier.TYPE_WALL;
