...
public class BlockHandlerCarpentersLadder extends BlockHandlerBase {
     ...
     * <p>
     * The classic type connects to adjacent ladders, and is retained for the look.
     *
        ...
        switch (dir) {
            ...
            default:
                for (double yLow = 0.125D; yLow < 1.0D; yLow += 0.25D) {
                    ...
                    renderBlockWithRotation(itemStack, x, y, z, 0.125D, yLow, 0.0D, 0.1875D, yHigh, 0.125D, dir); // xLow
                                                                                                                  // nub
                    renderBlockWithRotation(itemStack, x, y, z, 0.8125D, yLow, 0.0D, 0.875D, yHigh, 0.125D, dir); // xHigh
                                                                                                                  // nub
                    renderBlockWithRotation(itemStack, x, y, z, 0.125D, yLow, 0.125D, 0.875D, yHigh, 0.1875D, dir); // Full
                                                                                                                    // width
                }
                break;
        }
