...
public class RenderHelper extends VertexHelper {
    ...
    private static final ThreadLocal<RenderHelper> threadRenderer = ThreadLocal.withInitial(RenderHelper::new);
    ...
    public final RenderHelperCollapsible renderHelperCollapsible = new RenderHelperCollapsible();
    public final HelperCorner helperCorner = new HelperCorner();
    public final HelperOblique helperOblique = new HelperOblique();
    public final HelperOblWedge helperOblWedge = new HelperOblWedge();
    public final HelperPrism helperPrism = new HelperPrism();
    public final HelperOrthoWedge helperOrthoWedge = new HelperOrthoWedge();
    public final HelperTriangle helperTriangle = new HelperTriangle();
    public final RenderHelperFlowerPot renderHelperFlowerPot = new RenderHelperFlowerPot();
    ...
    public RenderHelperCollapsible getRenderHelperCollapsible() {
        return renderHelperCollapsible;
    }

    public HelperTriangle getHelperTriangle() {
        return helperTriangle;
    }

    public HelperOrthoWedge getHelperOrthoWedge() {
        return helperOrthoWedge;
    }

    public HelperOblWedge getHelperOblWedge() {
        return helperOblWedge;
    }

    public HelperOblique getHelperOblique() {
        return helperOblique;
    }

    public HelperPrism getHelperPrism() {
        return helperPrism;
    }

    public RenderHelperFlowerPot getRenderHelperFlowerPot() {
        return renderHelperFlowerPot;
    }

    public HelperCorner getHelperCorner() {
        return helperCorner;
    }
    ...
    protected void prepareRender(RenderBlocks renderBlocks, ForgeDirection side, double x, double y, double z,
        ...
        if (BlockHandlerCarpentersSlope.getInstance().isSideSloped
                || BlockHandlerCarpentersCollapsibleBlock.getInstance().isSideSloped) {
            switch (side) {
                case DOWN:
                    yMin -= renderOffset;
                    yMax -= renderOffset;
    ...
    public class RenderHelperCollapsible {
         ...
         */
        public void renderSlopeYNegZNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.DOWN, x, y, z, icon);
         ...
         */
        public void renderSlopeYNegZPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.DOWN, x, y, z, icon);
         ...
         */
        public void renderSlopeYPosZNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.UP, x, y, z, icon);
         ...
         */
        public void renderSlopeYPosZPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.UP, x, y, z, icon);
         ...
         */
        public void renderSlopeXNegYNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.DOWN, x, y, z, icon);
         ...
         */
        public void renderSlopeXPosYNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.DOWN, x, y, z, icon);
         ...
         * Renders the given texture to the top West slope.
         */
        public void renderSlopeXNegYPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.UP, x, y, z, icon);
         ...
         * Renders the given texture to the top East slope.
         */
        public void renderSlopeXPosYPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.UP, x, y, z, icon);
    ...
    public class HelperCorner {

        /**
         * Renders the given texture to the North sloped face of the block.
         */
        public void renderSlopeZNeg(RenderBlocks renderBlocks, int slopeID, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.NORTH, x, y, z, icon);
         ...
         */
        public void renderSlopeZPos(RenderBlocks renderBlocks, int slopeID, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.SOUTH, x, y, z, icon);
         ...
         */
        public void renderSlopeXNeg(RenderBlocks renderBlocks, int slopeID, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.WEST, x, y, z, icon);
         ...
         */
        public void renderSlopeXPos(RenderBlocks renderBlocks, int slopeID, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.EAST, x, y, z, icon);
    ...
    public class HelperOblique {
         ...
         */
        public void renderIntObliqueYNeg(RenderBlocks renderBlocks, int slopeID, double x, double y, double z,
                IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.NORTH, x, y, z, icon);
         ...
         */
        public void renderIntObliqueYPos(RenderBlocks renderBlocks, int slopeID, double x, double y, double z,
                IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.NORTH, x, y, z, icon);
         ...
         */
        public void renderExtObliqueYNegLeft(RenderBlocks renderBlocks, int slopeID, double x, double y, double z,
                IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.NORTH, x, y, z, icon);
         ...
         * Renders the given texture to exterior oblique bottom face on right.
         */
        public void renderExtObliqueYNegRight(RenderBlocks renderBlocks, int slopeID, double x, double y, double z,
                IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.NORTH, x, y, z, icon);
         ...
         */
        public void renderExtObliqueYPosLeft(RenderBlocks renderBlocks, int slopeID, double x, double y, double z,
                IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.NORTH, x, y, z, icon);
         ...
         */
        public void renderExtObliqueYPosRight(RenderBlocks renderBlocks, int slopeID, double x, double y, double z,
                IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.NORTH, x, y, z, icon);
    ...
    public class HelperPrism {
         ...
         */
        public void renderSlopeYNegXNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.WEST, x, y, z, icon);
         ...
         */
        public void renderSlopeYNegXPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.EAST, x, y, z, icon);
         ...
         */
        public void renderSlopeYPosXNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.WEST, x, y, z, icon);
         ...
         */
        public void renderSlopeYPosXPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.EAST, x, y, z, icon);
         ...
         */
        public void renderWestPointSlopeZNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.NORTH, x, y, z, icon);
         ...
         */
        public void renderWestPointSlopeZPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.SOUTH, x, y, z, icon);
         ...
         */
        public void renderEastPointSlopeZNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.NORTH, x, y, z, icon);
         ...
         */
        public void renderEastPointSlopeZPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.SOUTH, x, y, z, icon);
         ...
         */
        public void renderNorthPointSlopeXNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.WEST, x, y, z, icon);
         ...
         */
        public void renderNorthPointSlopeXPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.EAST, x, y, z, icon);
         ...
         */
        public void renderSouthPointSlopeXNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.WEST, x, y, z, icon);
         ...
         */
        public void renderSouthPointSlopeXPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.EAST, x, y, z, icon);
         ...
         * Renders the given texture to the North sloped face of the block.
         */
        public void renderWedgeSlopeZNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            RenderHelper.get().getHelperOblWedge().renderSlopeZNeg(renderBlocks, Slope.ID_WEDGE_POS_N, x, y, z, icon);
        }

        /**
         * Renders the given texture to the South sloped face of the block.
         */
        public void renderWedgeSlopeZPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            RenderHelper.get().getHelperOblWedge().renderSlopeZPos(renderBlocks, Slope.ID_WEDGE_POS_S, x, y, z, icon);
        }

        /**
         * Renders the given texture to the West sloped face of the block.
         */
        public void renderWedgeSlopeXNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            RenderHelper.get().getHelperOblWedge().renderSlopeXNeg(renderBlocks, Slope.ID_WEDGE_POS_W, x, y, z, icon);
        }

        /**
         * Renders the given texture to the East sloped face of the block.
         */
        public void renderWedgeSlopeXPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            RenderHelper.get().getHelperOblWedge().renderSlopeXPos(renderBlocks, Slope.ID_WEDGE_POS_E, x, y, z, icon);
        }
    }

    public class HelperOrthoWedge {

        /**
         * Renders the given texture to the bottom face of the block.
         */
        public void renderFaceYNeg(RenderBlocks renderBlocks, int slopeID, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.DOWN, x, y, z, icon);
         ...
         */
        public void renderFaceYPos(RenderBlocks renderBlocks, int slopeID, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.UP, x, y, z, icon);
         ...
         * Renders the given texture to the North face of the block.
         */
        public void renderFaceZNeg(RenderBlocks renderBlocks, int slopeID, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.NORTH, x, y, z, icon);
         ...
         * Renders the given texture to the South face of the block.
         */
        public void renderFaceZPos(RenderBlocks renderBlocks, int slopeID, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.SOUTH, x, y, z, icon);
         ...
         * Renders the given texture to the West face of the block.
         */
        public void renderFaceXNeg(RenderBlocks renderBlocks, int slopeID, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.WEST, x, y, z, icon);
         ...
         * Renders the given texture to the East face of the block.
         */
        public void renderFaceXPos(RenderBlocks renderBlocks, int slopeID, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.EAST, x, y, z, icon);
    ...
    public class HelperTriangle {

        /**
         * Renders a half triangle on the North left face of the block.
         */
        public void renderFaceZNegXPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.NORTH, x, y, z, icon);
         ...
         */
        public void renderFaceZNegXNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.NORTH, x, y, z, icon);
         ...
         */
        public void renderFaceZPosXNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.SOUTH, x, y, z, icon);
         ...
         */
        public void renderFaceZPosXPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.SOUTH, x, y, z, icon);
         ...
         */
        public void renderFaceXNegZNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.WEST, x, y, z, icon);
         ...
         */
        public void renderFaceXNegZPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.WEST, x, y, z, icon);
         ...
         */
        public void renderFaceXPosZPos(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.EAST, x, y, z, icon);
         ...
         */
        public void renderFaceXPosZNeg(RenderBlocks renderBlocks, double x, double y, double z, IIcon icon) {
            prepareRender(renderBlocks, ForgeDirection.EAST, x, y, z, icon);
