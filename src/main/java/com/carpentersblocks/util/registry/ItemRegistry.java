...
public class ItemRegistry {
    ...
    public static void preInit(FMLPreInitializationEvent event, Configuration config) {
        ...
        itemHammerDamageChanceFromSlopes = config
                .get("items", "itemHammerDamageChanceFromSlopes", itemHammerDamageChanceFromSlopes)
                .getDouble(itemHammerDamageChanceFromSlopes);
        itemHammerDamageChanceFromStairs = config
                .get("items", "itemHammerDamageChanceFromStairs", itemHammerDamageChanceFromStairs)
                .getDouble(itemHammerDamageChanceFromStairs);
        itemHammerDamageChanceFromCollapsible = config
                .get("items", "itemHammerDamageChanceFromCollapsible", itemHammerDamageChanceFromCollapsible)
    ...
    private static void registerRecipes() {
        if (enableHammer) {
            GameRegistry.addRecipe(
                    ...
                    new Object[] { "XX ", " YX", " Y ", 'X', Items.iron_ingot, 'Y',
