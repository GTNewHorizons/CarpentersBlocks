    ...
    public float[] genBounds(Slope slope, int slice, int precision, int pass) {
        ...
        switch (slope.slopeID) {
            ...
            case Slope.ID_OBL_EXT_POS_NW:
                return new float[] { zeroPassOffset + zeroOffset * (1.0F - zeroPassOffset), 0.0F,
                        1.0F - oneOffset * (1.0F - zeroPassOffset), 1.0F, onePassOffset, 1.0F };
            case Slope.ID_OBL_EXT_POS_SW:
                return new float[] { zeroPassOffset + zeroOffset * (1.0F - zeroPassOffset), 0.0F, 0.0F, 1.0F,
                        onePassOffset, oneOffset * (1.0F - zeroPassOffset) };
            case Slope.ID_OBL_EXT_POS_NE:
                return new float[] { 0.0F, 0.0F, zeroPassOffset + zeroOffset * (1.0F - zeroPassOffset),
                        oneOffset * (1.0F - zeroPassOffset), onePassOffset, 1.0F };
            case Slope.ID_OBL_EXT_POS_SE:
                return new float[] { 0.0F, 0.0F, 0.0F, oneOffset * (1.0F - zeroPassOffset), onePassOffset,
                        1.0F - zeroPassOffset - zeroOffset * (1.0F - zeroPassOffset), };
            ...
            case Slope.ID_OBL_EXT_NEG_NW:
                return new float[] { zeroPassOffset + zeroOffset * (1.0F - zeroPassOffset), 1.0F - onePassOffset,
                        1.0F - oneOffset * (1.0F - zeroPassOffset), 1.0F, 1.0F, 1.0F };
            case Slope.ID_OBL_EXT_NEG_SW:
                return new float[] { zeroPassOffset + zeroOffset * (1.0F - zeroPassOffset), 1.0F - onePassOffset, 0.0F,
                        1.0F, 1.0F, oneOffset * (1.0F - zeroPassOffset) };
            case Slope.ID_OBL_EXT_NEG_NE:
                return new float[] { 0.0F, 1.0F - onePassOffset, zeroPassOffset + zeroOffset * (1.0F - zeroPassOffset),
                        oneOffset * (1.0F - zeroPassOffset), 1.0F, 1.0F };
            case Slope.ID_OBL_EXT_NEG_SE:
                return new float[] { 0.0F, 1.0F - onePassOffset, 0.0F, oneOffset * (1.0F - zeroPassOffset), 1.0F,
                        1.0F - zeroPassOffset - zeroOffset * (1.0F - zeroPassOffset) };
            ...
            case Slope.ID_PRISM_POS:
                return new float[] { zeroOffset * 0.5F, 0.0F, zeroOffset * 0.5F, 1.0F - zeroOffset * 0.5F,
                        oneOffset * 0.5F, 1.0F - zeroOffset * 0.5F };
            case Slope.ID_PRISM_NEG:
                return new float[] { zeroOffset * 0.5F, 1.0F - oneOffset * 0.5F, zeroOffset * 0.5F,
                        1.0F - zeroOffset * 0.5F, 1.0F, 1.0F - zeroOffset * 0.5F };
            default: {
                ...
                switch (slope.slopeID) {
                    case Slope.ID_PRISM_WEDGE_POS_N:
                        switch (pass) {
                            ...
                            case 2:
                                if (renderPrism) {
                                    return new float[] { zeroOffset * 0.5F, 0.0F, 0.0F, 1.0F - zeroOffset * 0.5F,
                                            oneOffset * 0.5F, 0.5F };
                                }
                        }
                        break;
                    case Slope.ID_PRISM_WEDGE_POS_S:
                        switch (pass) {
                            ...
                            case 2:
                                if (renderPrism) {
                                    return new float[] { zeroOffset * 0.5F, 0.0F, 0.5F, 1.0F - zeroOffset * 0.5F,
                                            oneOffset * 0.5F, 1.0F };
                                }
                        }
                        break;
                    case Slope.ID_PRISM_WEDGE_POS_W:
                        switch (pass) {
                            ...
                            case 2:
                                if (renderPrism) {
                                    return new float[] { 0.0F, 0.0F, zeroOffset * 0.5F, 0.5F, oneOffset * 0.5F,
                                            1.0F - zeroOffset * 0.5F };
                                }
                        }
                        break;
                    case Slope.ID_PRISM_WEDGE_POS_E:
                        switch (pass) {
                            ...
                            case 2:
                                if (renderPrism) {
                                    return new float[] { 0.5F, 0.0F, zeroOffset * 0.5F, 1.0F, oneOffset * 0.5F,
                                            1.0F - zeroOffset * 0.5F };
                                }
                        }
                        break;
