...
public class EntityCarpentersTile extends EntityBase {
    ...
    private static final String TAG_DESIGN = "tile"; // Description holding for compatibility with pre-3.2.0
    ...
    public boolean attackEntityFrom(DamageSource damageSource, float par2) {
        if (!worldObj.isRemote) {
            ...
            if (entity instanceof EntityPlayer
                    && PlayerPermissions.hasElevatedPermission(this, (EntityPlayer) entity, false)) {
