...
public class TECarpentersFlowerPot extends TEBase {
    ...
    public void onDataPacket(NetworkManager net, S35PacketUpdateTileEntity pkt) {
        ...
        if (world.isRemote) {
            ...
            /*
             * The server doesn't send particle spawn packets, so it has to be handled client-side. This spawns the
             * fertilization effect as seen when growing saplings or crops with bonemeal.
             */
